...
const Catalogue = () => {
  ...
  <div class="card-body">
    ...
    <p class="card-text" style={{fontSize:'13px'}}>Title: Wave Climate Variability and Trends in Tuvalu Based on a 44-Year High-Resolution Wave Hindcast.</p>
...
<img style={{height:'150px'}} src={require('../reports/earth2.png')} class="card-img-top" alt="Loading.."/>
<div class="card-body">
<h5 class="card-title">Research Paper</h5>
<p class="card-text" style={{fontSize:'13px'}}>Title: A National-Scale Coastal Flood Hazard Assessment for the Atoll Nation of Tuvalu<br/><br/></p>
<a href = {Pdf} target = "_blank" rel="noopener noreferrer"  type="button" className="btn btn-primary">Browse</a>
</div>
</div>
</div>
