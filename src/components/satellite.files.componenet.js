...
import UploadService from "../services/satellite-files.service";
    ...
    const handleFileRemove = (e) => {
      ...
      .then(res => {
        ...
        for (var i=0; i<file.length; i++){
          ...
          axios.delete(`https://opmdata.gem.spc.int/shoreline/api/satellite_file/`+file[i].name,{
            headers:{
    ...
    return (
      <div>
        <div className="alert alert-info" role="alert">
          A Total of 1 files is required to be uploaded. Recommended file labelling:
            <ul>
               <li key={1}>TV_AtollName_year_orthorectified.tif</li>
            </ul>
          </div>
